Public Class MenuZel
    ...
    Private Sub btnHard_Click(sender As Object, e As EventArgs) Handles btnHard.Click
        Tutorial.Timer1.Interval = 200
        Tutorial.Timer2.Interval = 200
        Tutorial.Timer3.Interval = 200
        Dungeon_1.Timer1.Interval = 200
        Dungeon_1.Timer2.Interval = 200
        Dungeon_1.Timer3.Interval = 200
        Dungeon_1.Timer4.Interval = 200
        Dungeon_1.Timer5.Interval = 200
        Dungeon_1.Timer6.Interval = 200
        Dungeon_Up.Timer1.Interval = 200
        Dungeon_Up.Timer2.Interval = 200
        Dungeon_Up.Timer3.Interval = 200
        Tutorial.ShowDialog()
    End Sub
